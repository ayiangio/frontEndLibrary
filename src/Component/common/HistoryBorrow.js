...
import { getListBorrow } from '../../Publics/redux/action/borrow';
...
class History extends Component {
    ...
    componentDidMount = async () => {
        await this.props.dispatch(getListBorrow(localStorage.idUser));
        this.setState({
